...
@Component({
  ...
  styles: [`
    ...
    .gate-overlay {
      ...
      background: rgba(244, 246, 251, 0.75); border-radius: 20px;
    ...
    .gate-card {
      ...
      box-shadow: 0 20px 60px rgba(96, 89, 247, 0.15);
    }
    .lock-icon { font-size: 3rem; margin-bottom: 1rem; }
    h3 { margin-bottom: 0.75rem; }
    p { color: var(--text-secondary); margin-bottom: 1.5rem; font-size: 0.9375rem; }
    .gate-hint { color: var(--text-muted); font-size: 0.8125rem; margin-top: 0.75rem; margin-bottom: 0; }
  `],
})
